...
namespace Celtic.Api.Migrations
{
    ...
    [Migration("20260913212200_AddPlayerSigningFeePaid")]
    partial class AddPlayerSigningFeePaid
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Celtic.Api.Models.Player", b =>
                {
                    ...
                    b.Property<bool>("SigningFeePaid")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("Celtic.Api.Models.PlayerTeam", b =>
                {
                    b.Property<Guid>("PlayerId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Celtic.Api.Models.Team", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Celtic.Api.Models.UserPushSubscription", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Celtic.Api.Models.Event", b =>
                {
                    ...
                    b.HasOne("Celtic.Api.Models.Team", "Team")
                        .WithMany("Events")
